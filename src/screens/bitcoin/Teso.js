...
export const TesoScreen = ({ navigation }) => {
  ...
  const Data = () => {
    fetch("https://be.control-room.app/api/salesChannels?page=1&limit=20", {
      method: "GET",
      headers: { 
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IlRVTzYiLCJpZCI6NiwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjY1MTQ4MDU5LCJleHAiOjE2Njc4MjY0NTl9.ake1PT2VGDret0lEFtXDTEA_HQR3CS5nVIFkeVF8XFI'    },
    })
      .then((res) => {
        return res.json();       
      })
